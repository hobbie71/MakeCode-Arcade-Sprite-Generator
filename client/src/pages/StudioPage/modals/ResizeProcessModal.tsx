...
// Blessed tile sizes — shown as the only size choices when the asset type is Tile.
const TILE_SIZES = [16, 8];
...
/** A row of one-click size chips (square sizes). `format` renders the label. */
function SizeChips({
  sizes,
  w,
  h,
