      ...
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-6 py-12 lg:grid-cols-2 lg:gap-16 lg:py-20">
        <div>
          ...
          <p className="mt-5 max-w-md text-lg text-ink-muted">
            Describe it in words or upload a photo. MakeSpriteCode generates
            clean pixel art on the Arcade palette, lets you fine-tune every
            pixel, and copies straight into your game. Free, instant, no
            account.
          </p>
